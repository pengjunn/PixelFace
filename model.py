...
from pixel_models.blocks import ConstantInput, StyledConv, ToRGB, PixelNorm, EqualLinear, Unfold, LFF, Con_PosFold6, Upsample
import tensor_transforms as tt
from pixel_models.gamsformer import TransformerLayer
...
class PixelFace(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        kwargs = {
            "from_len":  16*16, 
            "to_len":  self.n_latent,   # The from/to tensor lengths
            "from_dim":  512,  
            "to_dim":  512,             # The from/to tensor dimensions
            "from_gate": False, 
            "to_gate": False,           # Gate attention flow between from/to tensors
            "pos_dim": 0,       
            "kmeans":False,     
            "integration": "both",
            "kmeans_iters":1
